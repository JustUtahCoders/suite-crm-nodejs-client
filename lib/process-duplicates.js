...
(async () => {
  ...
  const duplicates = JSON.parse(fs.readFileSync('./artifacts/duplicates.json', 'utf-8'))
...
function readPage(page) {
  return JSON.parse(fs.readFileSync(`./artifacts/contacts-${page * 20}-${page * 20 + 20}.json`, "utf-8"))
}
